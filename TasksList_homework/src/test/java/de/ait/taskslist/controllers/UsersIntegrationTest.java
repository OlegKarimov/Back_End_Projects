...
import de.ait.taskslist.dto.NewUserDto;
import de.ait.taskslist.dto.UpdateUserDto;
...
class UsersIntegrationTest {
    ...
    private static final NewUserDto NEW_USER = NewUserDto.builder()
    ...
    class AddUserTests {
        ...
        void add_user() throws Exception {
            String body = objectMapper.writeValueAsString(NEW_USER);
